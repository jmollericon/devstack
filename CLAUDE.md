...
DevStack is a Docker-based local development environment supporting multiple PHP versions (7.4, 8.2, 8.4), MySQL 5.7, PostgreSQL 16, phpMyAdmin, and pgAdmin — all orchestrated via `docker-compose.yml` and managed through `devstack.sh`.
